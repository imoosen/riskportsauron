...
public class HttpClientUtil {
    ...
    public static String doPost(String apiUrl,String charset) {
        return doPost(apiUrl, new HashMap<String, Object>(),charset);
    }
     ...
     * @return
     */
    public static String doPost(String apiUrl, Map<String, Object> params,String charset,Map<String, String> headerMap, Header[] headers) {
